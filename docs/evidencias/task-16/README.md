...
As capturas compartilhadas na conversa não estão arquivadas nesta pasta. O
arquivo QVF foi verificado por tamanho e SHA-256, mas ainda não foi reimportado
para testar a restauração. A [análise da Task 16](../../task-16-cobertura-lacunas.md)
