...
- Finalizar a Tela 1: incluir nota de fonte/período, guardar capturas da versão final e ajustar a coloração por pessoa. Com julho e dois municípios selecionados, Porto Alegre (R$ 4,16/pessoa) e Pouso Novo (R$ 442,69/pessoa) aparecem no mesmo tom; os tooltips estão corretos. Testar uma gradação por medida no mapa de áreas, mantendo 0–R$ 1.018,22 como limites globais. A equipe decidiu manter a formatação atual da legenda de pontos e do valor por pessoa no tooltip; isso não bloqueia a conclusão da tela.
- Aplicar e retestar os pontos das Telas 3 a 6 descritos abaixo, sem alterar os cálculos validados. Na Tela 2, o filtro de julho já se propaga visualmente aos dois mapas; faltam a conferência numérica no mapa, as demais telas e a captura da versão exportada.
...
| 1 — Distribuição geográfica | A primeira captura mostrava `Mês` em ordem alfabética, `localizacao_mapa` e números em formato inglês. **Retestes parciais:** meses e rótulo “Município” corrigidos; com Porto Alegre selecionado, o ponto aparece em escala regional e o tooltip confirma código IBGE 4314902, R$ 5.782.558,14 e população 1.389.322. A escala de cor permanece em 0–R$ 1.018,22 com a cidade selecionada. Nova captura sem seleções mostra as legendas na horizontal com todos os limites visíveis. A legenda de pontos ainda exibe `R$ 5,782,558.14` e o tooltip exibe `R$4.16`; a equipe optou por manter essa formatação. **Estado vazio corrigido:** com Aceguá selecionado na Tela 3, os dois mapas permanecem na região do RS e exibem “Sem movimentações FUNDEC nesta base para a seleção atual.” **Reteste com dados:** Porto Alegre mostra o ponto e a área municipal preenchida. Com `mes_nome = Julho`, os dois mapas exibem municípios com movimentação no mês. Ao selecionar Porto Alegre e Pouso Novo juntos, os tooltips mostram respectivamente R$ 4,16 e R$ 442,69 por pessoa, mas as áreas aparecem no mesmo tom e a legenda tem uma única faixa R$ 0,00–R$ 1.018,22. | Incluir nota de fonte, período e população 2024; ajustar a gradação das cores preservando a escala global; retestar recurso e guardar as capturas finais do QVF exportado. |
...
Os limites globais fixos de 0 a R$ 1.018,22 permitem comparar municípios na mesma escala. O reteste com julho e dois municípios confirma, porém, que Porto Alegre (R$ 4,16/pessoa) e Pouso Novo (R$ 442,69/pessoa) recebem visualmente o mesmo tom no mapa de áreas, embora os tooltips tragam valores distintos e corretos. A coloração deve ser revista sem trocar a medida ou afrouxar os limites globais; depois, retestar o recorte de julho e a vista sem filtros.
