...
Revisão iniciada em 19/09/2026 sobre o [snapshot 11](../../../qlik/versoes-do-app/11-task-19/README.md), as [capturas arquivadas das Telas 0 a 6](../../screenshots/tela-6-resumo/) e novas capturas enviadas na conversa em 19/09. As capturas arquivadas são do aplicativo antes da exportação de 18/09. As primeiras capturas novas mostram a cópia do app após a limpeza das pastas de teste; capturas posteriores registram correções nas Telas 0 a 2 e nos títulos das pastas. Falta testar a cópia usada nos prints e no pitch, aplicar as correções abaixo e exportar um **novo QVF com dados**. Este documento não atesta a conclusão da issue.
...
| 3 — Cobertura | A captura atual sem filtros confirma 478 / 334 / 144 e a nota que distingue ausência de movimentação nesta base de ausência de atendimento. A tabela não tem título e abre com códigos como `nao_listado_sem_registro`. Ela inclui os 497 municípios do RS, entre eles 19 fora da lista de afetados; os KPIs se referem apenas aos 478 listados. Essa diferença de universo não está explícita na tela. | Dar à tabela o título “Situação dos 497 municípios do RS na lista da Defesa Civil e na base FUNDEC” e acrescentar à nota: “Tabela: 497 municípios do RS; indicadores: 478 municípios listados pela Defesa Civil.” Depois, substituir os códigos técnicos por rótulos legíveis na apresentação, mantendo os códigos originais na base. Confirmar que 478 / 334 / 144 continuam iguais. |
