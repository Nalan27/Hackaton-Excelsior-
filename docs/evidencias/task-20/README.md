...
- Aplicar e retestar os pontos das Telas 3 a 6 descritos abaixo, sem alterar os cálculos validados. Na Tela 2, falta testar a seleção de julho nas demais telas e arquivar a captura da versão exportada.
